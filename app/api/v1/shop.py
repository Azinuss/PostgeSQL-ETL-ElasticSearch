...
@router.get("/", summary="List of products", description= "Get list of products",
...
async def get_product(product_id: int,
    ...
    product = shop_persistence.get_by_id(product_id)
    if product:
        return ShopSchema(id=product.id ,name=product.name, description=product.description,
...
@router.post("/buy", summary="Buy product", description="Buy product",
